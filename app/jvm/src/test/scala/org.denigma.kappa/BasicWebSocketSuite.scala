...
abstract class BasicWebSocketSuite extends BasicKappaSuite with KappaPicklers {
  ...
  protected def collectPartialKappaMessageUntil[T](probe: TestSubscriber.Probe[Message], timeout: FiniteDuration = 5000 millis)(partial: PartialFunction[KappaMessage, T]) =
