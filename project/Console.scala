object Console
{
  ...
  protected val libs =
    """
      ...
      |load.ivy("com.typesafe.akka" %% "akka-stream" % "2.4.7")
      |load.ivy("com.typesafe.akka" %% "akka-http-core" % "2.4.7")
      |load.ivy("com.typesafe.akka" %% "akka-http-experimental" % "2.4.7")
      |load.ivy("io.circe" %% "circe-core" % "0.4.1")
      |load.ivy("io.circe" %% "circe-generic" % "0.4.1")
      |load.ivy("io.circe" %% "circe-parser" % "0.4.1")
      |load.ivy("de.heikoseeberger" %% "akka-http-circe" % "1.7.0")
      |//SBOL
      |load.ivy("org.sbolstandard" % "libSBOLj" % "2.0.1")
      |//matrix
